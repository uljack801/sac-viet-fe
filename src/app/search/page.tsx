...
export default function Search() {
  ...
  return (
    <div className="pt-28 m-2 max-xl:m-2 max-[1540px]:mx-36 mx-96">
      <p className="max-sm:text-2xl max-lg:text-2xl max-xl:text-3xl  text-3xl font-bold text-[var(--color-text-root)] flex justify-center items-center my-10 p-6 rounded-sm shadow bg-white">Kết quả tìm kiếm &quot;{search}&quot;</p>
